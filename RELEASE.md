...
This document describes how to publish a new release of `wgpu-ffx`.
...
```
- [Unreleased](https://github.com/cwfitzgerald/wgpu-ffx/compare/vPREVIOUS...HEAD)
```
Update it and add a new entry:
```
- [Unreleased](https://github.com/cwfitzgerald/wgpu-ffx/compare/vX.Y.Z...HEAD)
- [vX.Y.Z](https://github.com/cwfitzgerald/wgpu-ffx/compare/vPREVIOUS...vX.Y.Z)
```
...
Verify:
- [ ] The crate is visible at https://crates.io/crates/wgpu-ffx/X.Y.Z
- [ ] Docs are building at https://docs.rs/wgpu-ffx/X.Y.Z
- [ ] The GitHub release exists at https://github.com/cwfitzgerald/wgpu-ffx/releases/tag/vX.Y.Z
